                ...
                {tickets.map((ticket) => {
                    return  <div className="card col-sm-3 ml-4 mr-4" >
                                <div className="card-body">
                                    ...
                                    <button className="card-link" onClick={() => handleDelete(ticket._id)}>Delete</button>
                                    <Link to={'/newassign/' + ticket._id + '/' + ticket.userId} ><button className="card-link">Assing</button></Link>
                                </div>
                            </div>
                })}
            </div>
